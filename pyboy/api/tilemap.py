...
"""
The Game Boy uses two tile maps at the same time to draw graphics on the screen. 

1. this method will provide one for the _background_ tiles. The game chooses whether it wants to use 
# the low or the high tilemap.
```
...
2. this method will provide one for the _window_ tiles. The game chooses whether it wants to use 
the low or the high tilemap.
```
